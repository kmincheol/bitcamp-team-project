-- 회원데이터
insert into mbr(mbr_id,user_id,pwd,name,bth_dt,gndr,tel,email,bas_addr,det_addr,login_type, mgr)
values(1,'testId','1111','김민철','1995-5-5','남','010-1111-1111','babo@haha.com','비트캠프','강남','face', 1);
