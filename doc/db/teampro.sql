...
ALTER TABLE atch_file
  MODIFY COLUMN atch_file_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '첨부파일번호';
...
CREATE TABLE post (
  ...
  stat         VARCHAR(20)  NULL     COMMENT '게시글처리상태', -- 게시글처리상태
...
ALTER TABLE post
  MODIFY COLUMN post_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '게시글번호';
...
CREATE TABLE tm (
  ...
  ddt          DATETIME     NULL     COMMENT '팀폐쇄일자', -- 팀폐쇄일자
...
CREATE TABLE mbr (
  ...
  wthd_wth   BOOLEAN      NULL     DEFAULT 0 COMMENT '탈퇴여부', -- 탈퇴여부
  wthd_res   VARCHAR(255) NULL     COMMENT '탈퇴이유', -- 탈퇴이유
  wthd_dt    DATETIME     NULL     COMMENT '탈퇴날짜', -- 탈퇴날짜
...
ALTER TABLE ripple
  MODIFY COLUMN ripple_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '댓글번호';
...
ALTER TABLE mtch
  MODIFY COLUMN post_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '경기번호';
...
ALTER TABLE tag
  MODIFY COLUMN tag_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '태그번호';
...
ALTER TABLE boardtype
  MODIFY COLUMN boardtype_id INTEGER(30) NOT NULL AUTO_INCREMENT COMMENT '게시판유형번호';
