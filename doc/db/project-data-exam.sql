...
insert into rcrm_file(rcrm_file_id,rcrm_id,file_path,file_type)
values(2,2,'upload/rcrm/b.png','이미지');
insert into rcrm_file(rcrm_file_id,rcrm_id,file_path,file_type)
values(3,3,'upload/rcrm/c.avi','영상');
...
values(1,1,'upload/match/a.jpg','이미지');
insert into mtch_file(mtch_file_id,mtch_id,file_path,file_type)
values(2,2,'upload/match/b.jpg','이미지');
insert into mtch_file(mtch_file_id,mtch_id,file_path,file_type)
values(3,3,'upload/match/c.jpg','이미지');
...
-- 자유게시판 첨부파일
insert into free_file(free_file_id,free_id,file_path,file_type)
...
-- 답변데이터
insert into ans(ans_id,qstn_id,titl,ans_cont)
