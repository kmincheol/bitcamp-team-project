        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="풋살장" id="keyword" size="15"> 
                    <button type="submit">검색하기</button> 
                    <input type="button" value="저장" onclick="setParentText()">
                </form>
            </div>
        </div>
        <hr>
...
function setParentText(){
  opener.document.getElementById("pInput").value = document.getElementById("keyword").value
  window.close();
}
