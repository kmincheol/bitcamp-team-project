...
<html>
  <head>
    ...
    <script src="${contextRootPath}/filter.js/examples/list4.js" type="text/javascript"></script>
    <script src="${contextRootPath}/filter.js/examples/data/movies.js" type="text/javascript"></script>
  </head>
  <body>
