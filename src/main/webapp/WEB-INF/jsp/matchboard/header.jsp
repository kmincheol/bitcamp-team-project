...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="${contextRootPath}">메인홈</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="${contextRootPath}/app/matchboard/">매치보드</a></li>
        
      <li class="nav-item active">
        <a class="nav-link" href="${contextRootPath}/app/announce/">공지사항</a></li>
    </ul>
