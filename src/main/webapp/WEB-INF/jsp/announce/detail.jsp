      ...
      <c:otherwise>
        <form action='update' method='post'>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control-plaintext" id="no" name='no' value='${announce.no}'
                readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" id="title" name='contents' rows='1' readonly>${announce.title}</textarea>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" id="contents" name='contents' rows='5' readonly>${announce.contents}</textarea>
            </div>
          </div>

          <div>
          <c:forEach items="${announce.files}" var="file">
            <img src='${contextRootPath}/upload/announce/${file.filePath}'>
            </c:forEach>
          </div>
          ...
          <div class="form-group row">
            <div class="col-sm-10">
              <a class="btn btn-primary" href='.'>목록</a> <a class="btn btn-primary"
                href='delete/${announce.no}'>삭제</a> <a
                href='${contextRootPath}/app/announce/update/${announce.no}' class="btn btn-primary btn-sm">변경</a>
            </div>
          </div>
