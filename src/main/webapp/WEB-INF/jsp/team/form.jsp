          ...
          <div class="join_form" style="height: 1500px;">
            <div class="join_form_left" style="height: 1150px;">
              ...
              <div class="row_group">
                <div class="join_row">
                  ...
                  <span class="ps_box int_pass" id="nameImg"> <input type="text"
                    id="teamArea" name="teamArea" title="활동 지역" class="int" maxlength="40">
                  </span>
                </div>
            ...
            <div class="join_form_right">
              ...
              <div class="uniformPhoto">
                <label for="photo" class="col-sm-5 col-form-label"><b>팀 유니폼</b></label> <br>
                <br>
                <div class="radiobtn" style="position: relative; left: 170px;">
                  <span class="custom-control custom-radio"
                    style="position: relative; right: 50px; width: 60px;"> <input
                    type="radio" class="uniformtrue custom-control-input" id="defaultUnchecked"
                    name="teamUniform"> <label class="custom-control-label"
                    for="defaultUnchecked">있음</label>
                  </span> <span class="custom-control custom-radio"
                    style="position: relative; left: 40px; bottom: 24px; width: 60px;"> <input
                    type="radio" class="uniformfalse custom-control-input" id="defaultChecked"
                    name="teamUniform" checked> <label class="custom-control-label"
                    for="defaultChecked">없음</label>
                  </span>
                </div>
                <br>
                <br>
