    ...
    <nav aria-label="목록 페이지 이동">
      <ul class="pagination justify-content-center">
        <li class="page-item ${pageNo <= 1 ? 'disabled' : ''}"><a class="page-link"
          href="?pageNo=${pageNo - 1}&pageSize=${pageSize}" style="background-color: gray; color: white; border-color: gray;">이전</a></li>
        <li class="page-item active"><span class="page-link" style="background-color: black; color: white; border-color: gray;">${pageNo}</span></li>
        <li class="page-item ${pageNo >= totalPage ? 'disabled' : ''}"><a class="page-link"
          href="?pageNo=${pageNo + 1}&pageSize=${pageSize}" style="background-color: gray; color: white; border-color: gray;">다음</a></li>
      </ul>
    </nav>
