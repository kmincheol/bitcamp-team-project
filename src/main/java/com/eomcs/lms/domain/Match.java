...
public String toString() {
	return "Match [no=" + no + ", teamNo=" + teamNo + ", otherTeamNo=" + otherTeamNo + ", teamSportsId=" + teamSportsId
			+ ", title=" + title + ", contents=" + contents + ", viewCount=" + viewCount + ", createdDate="
			+ createdDate + ", modifierDate=" + modifierDate + ", playDate=" + playDate + ", location=" + location
			+ ", stadiumName=" + stadiumName + ", stadiumLatitude=" + stadiumLatitude + ", stadiumLongitude="
			+ stadiumLongitude + ", telephone=" + telephone + ", cost=" + cost + ", team=" + team + ", teamMember="
			+ teamMember + ", otherTeam=" + otherTeam + ", teamTypeSports=" + teamTypeSports + ", matchApply="
			+ matchApply + ", teamAges=" + teamAges + ", teamLevel=" + teamLevel + ", tags=" + tags + ", member="
			+ member + ", teamType=" + teamType + ", matchApplly=" + matchApplly + "]";
}
public int getNo() {
	return no;
}
