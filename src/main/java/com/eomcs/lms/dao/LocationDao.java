...
public interface LocationDao {
  ...
  TopLocation TopLocationName(int topLocationNo); // 상위 지역번호를 주면 해당하는 지역이름 돌려줌.
  MiddleLocation MiddleLocationName(int middleLocationNo); // 하위 지역번호를 주면 해당하는 지역이름 돌려줌.
}
